...
class ThermostatViewModelTest {
    ...
    void setModel_populatesTargetTemp() {
        model.setActualTemp(22.0);
        assertEquals(20.0, vm.targetTempProperty().get());
    }

    @Test
    void setModel_populatesActualTemp() {
        model.setActualTemp(18.0);
        assertEquals(18.0, vm.actualTempProperty().get());
    }
...
| Change label format from `Target: 25.0 °C` to `Set: 25.0°` | **Breaks** ❌ | **Still passes** ✅ |
