...
<Img src='/img/lectures/web/qr2-good-fast-cheap-top.png'
  width={700}
  alt=''
/>

<div className='fragment'>
<Img src='/img/lectures/web/qr2-good-fast-cheap-bottom.png'
  width={700}
  alt=''
/>
</div>
...
```
In this test, mockSensor is acting as an (A) stub, (B) mock, (C) integration test fixture, or (D) spy.
</div>
...
```
<div className='fragment'>
In this test, mockSensor is acting as an (A) stub, (B) mock, (C) integration test fixture, or **(D) spy — it records method calls for later verification**.
</div>
</div>
...
Topics
* We've reviwed many important topics from Lecture 9 to Lecture 24.
* There are other important topics I did not review, including (but not limited to)
  * Domain Modeling
  * REST APIs
  * Teams & Collaboration
* I am happy to do so in the remaining time.
