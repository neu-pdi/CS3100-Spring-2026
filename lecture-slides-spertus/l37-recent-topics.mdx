...
* Today
  * Lecture: Highlights of skipped lectures and MapReduce
...
* You will know to seek tools to find performance bottlenecks.
</div>
...
<Img src="/img/lectures/web/l37-big-o-complexity.png" alt="TODO"
width={1024}
/ >
...
<div className='fragment'>
An atomic firmware write on day one is moderate effort. After a bricking incident, it's a migration <em>plus</em> legal costs, customer replacements, and reputational damage.
</div>
