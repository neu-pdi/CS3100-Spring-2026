...
<p>
This works — but all the UI construction, event handling, and data are decalred programmatically in one method. That won't scale.
</p>
...
public class AreaDashboardController {
    ...
    private void initialize() {
        Area livingRoom = new Area("Living Room",
            List.of(new Light("Ceiling Light", 50), new Shades("Shades",true), new Fan("Fan", 2)));
        setModel(livingRoom);
