...
**GA1 due today** — CookYourBooks group deliverable; submit through Pawtograder. Self-review required within 48hr of deadline

**Final Exam — April 22, 1–3 pm, WVF 20**
- Format: similar to quizzes + short-answer open-ended questions
- Practice exam shared next week
- **DRC accommodations:** schedule your appointment now
- **Conflicts:** report to course staff immediately

**New course for Fall 2026: CS 4535 — Software Design & Delivery**
- Ship real features to Pawtograder — the grader you use every day
- AI-assisted development on a production codebase with 1,500+ weekly users
- Must apply — visit [neu-se.github.io/CS4535-Fall-2026](https://neu-se.github.io/CS4535-Fall-2026/) to learn more

</div>

<aside className="notes">
**GA1:** Due today. Don't let students leave without submitting — this is the last moment to flag issues.

**Lab 14:** Remind students this is the lab for today's section. TAs have discussion facilitation notes built into the lab doc.

**Final exam:** Keep stressing DRC and conflict urgency — options shrink the longer they wait.

**CS 4535:** This is worth a real 30-second pitch. Pawtograder is what grades their work every day. CS 4535 is a chance to actually work on it — ship features, do user research, optimize the gradebook, build ops tooling. Selective enrollment, by application. Point them to the website. Students who liked the architecture and systems content of this course are exactly who this is for.
</aside>
...
<p style={{fontSize: '1.1em', marginTop: '1.5em'}}>
Go to <strong>pollev.com/jbell</strong> and when you get to it, here is today's magic number:
</p>

<p style={{fontSize: '4em', fontWeight: 'bold', color: '#9370DB', marginTop: '0.5em', letterSpacing: '0.1em'}}>
4512
</p>
<p>
Do not share the number with anyone else. Be sure to enter it correctly.
</p>

<aside className="notes">
Give students 30–45 seconds to join. The magic number gates the poll so only students in the room can respond.
</aside>
...
**GA1 due today** — submit before midnight, self-review required within 48hr of deadline

**Final Exam — April 22, 1–3 pm, WVF 20**
- Practice exam shared next week · DRC? Schedule now · Conflict? Tell us ASAP

**CS 4535: Software Design & Delivery — Fall 2026**
- Work on Pawtograder in production · AI-assisted · Selective enrollment
- Apply at [neu-se.github.io/CS4535-Fall-2026](https://neu-se.github.io/CS4535-Fall-2026/)

</div>

<aside className="notes">
End on CS 4535 — it's a great hook for students who just spent a semester thinking about software engineering principles. They've now lived inside Pawtograder as users; this is the chance to work on it as engineers. Keep it short and direct them to the website.
</aside>
