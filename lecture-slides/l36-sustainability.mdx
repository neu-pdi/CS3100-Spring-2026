...
<aside className="notes">
**This exercise makes the veil of ignorance concrete using a system students use every day.** "Unlimited submissions" sounds universally good — but behind the veil, the distributional effects are uneven.

**The Northeastern student benefits most.** Fast internet, modern hardware, free compute (subsidized by the university). The community college student bears the cost — their IT team pays per container-minute, and "unlimited" means the budget runs out by midterms. The student with slow internet is rate-limited by physics. The student who uses it as a debugger trades learning for convenience.
...
**Key teaching point:** A design that looks equitable ("everyone gets unlimited") can be inequitable in practice when stakeholders have different resources. The veil of ignorance surfaces this.
