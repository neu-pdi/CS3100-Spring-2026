...
The Model is cleanly on the domain side — no UI imports, fully testable. But notice the Controller: it contains decision-making logic <em>and</em> depends on <code>@FXML</code> widgets. The hexagonal boundary runs through the middle of the Controller. We'll fix this in L30.
</p>
...
> **Transition:** Now let's get hands-on with the JavaFX components you'll use to build Views...
</aside>
