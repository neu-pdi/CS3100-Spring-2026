...
- Objective 4: Scenarios, reframing table, safety debt, wrap-up (~20 min)

**Key pedagogical goal:** Students should leave understanding that every tool they've learned this semester (synchronized, .exceptionally(), circuit breakers, staged rollouts) is a safety mechanism. The difference is the stakes.
...
*GitHub:* struggled to maintain even 90% availability (Feb 2026)
...
- **Reliable and unsafe:** Therac-25 delivered correct doses most of the time — but its failure mode was lethal.
- **Safe but unreliable:** Hub crashes frequently but preserves device state and fails to safe defaults.

</div>

<aside className="notes">
**The critical insight is the Therac-25 example.** Students' intuition is that reliable = safe. The Therac-25 was highly reliable — it worked correctly the vast majority of the time. But when it failed, people died. Reliability measures how often something works. Safety measures what happens when it doesn't.

**GitHub availability:** Their February 2026 availability report showed they struggled to maintain even 90% availability. That's an availability failure — lots of downtime — but not a safety failure (nobody was physically harmed).
...
**AI connection:** You use Claude Code to generate a door lock controller. If you paste it without careful review, you've removed a Swiss cheese layer — **human code review** — the same layer Therac-25 removed when hardware interlocks were replaced. **You are responsible for the output.**
...
## The Citicorp Tower: When Blast Radius Leaves No Responsible Option

<div style={{fontSize: '0.8em'}}>

**1978, Manhattan.** Structural engineer William LeMessurier discovers after construction that a design change — welded joints instead of bolted, plus an unconsidered wind pattern — means the building could collapse in a storm that occurs every ~16 years.
...
LeMessurier **disclosed the flaw** and coordinated emergency repairs. Nobody was hurt.

</div>

<div className="fragment">

> "It's not the AI that's liable. It's either the people who made it or the people who use it or both." — David Parnas, ICSE 2025 Keynote

<p style={{fontSize: '0.8em', marginTop: '0.5em'}}>
Same L4 contracts framework — preconditions and postconditions — applied to <strong>professional accountability.</strong> ACM Code of Ethics: 1.2 "Avoid harm," 2.5 "Comprehensive evaluations."
</p>

</div>

<aside className="notes">
**Why LeMessurier acted:** Not because he was uniquely virtuous — but because the blast radius left no other responsible option. A collapsed skyscraper in midtown Manhattan would affect a 10-block radius. Thousands of people. When your system's blast radius includes human safety, you have a professional obligation to understand and mitigate every failure mode you discover.

**The Parnas quote:** David Parnas — who invented the information hiding concepts from L6 — put it simply in his ICSE 2025 keynote. The full version: "People who made it have a duty to have a specification and to make sure it meets that specification. People who use it have to make sure they've read the specification and aren't using it outside of the specification." This is L4's contracts framework applied to professional accountability.

**ACM Code of Ethics:** Principle 1.2 states "Avoid harm." Principle 2.5 requires "comprehensive and thorough evaluations of computer systems and their impacts, including analysis of possible risks." Blast radius analysis IS that evaluation.
