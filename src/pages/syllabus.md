...
The course consists of lectures, labs, assignments, and a semester-long project. The [Schedule](/schedule) page contains the specific dates and topics for each lecture and lab. Loosely, the course is organized as follows:
